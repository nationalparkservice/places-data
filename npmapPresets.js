******************************************************************************************
presets { 'building/building/building footprint': 
   { name: 'Building Footprint',
     fields: [ 'name', 'nps/unitcode', 'address', 'levels' ],
     geometry: [ 'area' ],
     icon: 'building',
     maki: 'maki',
     defaultOrder: 1,
  ...
  'building/building/bunker': 
   { name: 'Bunker',
     fields: [ 'name', 'nps/unitcode', 'address', 'levels', 'bunker_type' ],
     geometry: [ 'point' ],
     icon: 'building',
     maki: 'maki',
     defaultOrder: null,
     ...
     terms: [ 'air-raid shelter', 'fallout shelter', 'military bunker' ],
     searchable: true },
  'building/building/public building': 
   { name: 'Public Building',
     fields: [ 'name', 'nps/unitcode', 'address', 'levels', 'smoking' ],
     geometry: [ 'point' ],
     icon: 'building',
     maki: 'maki',
     defaultOrder: null,
  ...
  'building/agricultural/barn': 
   { name: 'Barn',
     fields: [ 'name', 'nps/unitcode', 'address', 'levels', 'landuse' ],
     geometry: [ 'point' ],
     icon: 'farm',
     maki: 'maki',
     defaultOrder: null,
  ...
  'building/agricultural/greenhouse': 
   { name: 'Greenhouse',
     ...
     terms: [ 'glasshouse', 'hothouse' ],
     searchable: true },
  'building/agricultural/ranch': 
   { name: 'Ranch',
     fields: [ 'name', 'nps/unitcode', 'operator', 'address', 'opening_hours' ],
     geometry: [ 'point' ],
     defaultOrder: null,
     matchScore: 1,
     tags: { landuse: 'farmland' },
     terms: [ 'barnyard', 'farmyard', 'dude ranch' ],
     searchable: true },
  ...
  'building/commercial/retail building': 
   { name: 'Retail Building',
     ...
     terms: [ 'commercial building', 'retail' ],
     searchable: true },
  'building/education/education center': 
   { name: 'Education Center',
     fields: [ 'name', 'nps/unitcode' ],
     geometry: [ 'point' ],
     defaultOrder: null,
     matchScore: 1,
     tags: { building: '*', amenity: 'education_centre' },
     terms: [ 'education', 'learning', 'learning center' ],
     searchable: true },
  ...
  'building/education/university building': 
   { name: 'University Building',
     ...
     terms: [ 'university', 'college', 'higher ed', 'higher education' ],
     searchable: true },
  'building/entrance/entrance %2f exit': 
   { name: 'Entrance / Exit',
     ...
     terms: [ 'building entrance', 'building exit', 'emergency exit' ],
     searchable: true },
  'building/historic/historic building': 
   { name: 'Historic Building',
     fields: [ 'name', 'nps/unitcode', 'site_type' ],
     geometry: [ 'point' ],
     defaultOrder: 5,
     matchScore: 1,
  ...
  'building/historic/historic cabin': 
   { name: 'Historic Cabin',
     ...
     defaultOrder: null,
     matchScore: 1,
     tags: { building: 'cabin', historic: '*' },
     searchable: true },
  'building/place of worship/cathedral': 
   { name: 'Cathedral',
     fields: [ 'name', 'nps/unitcode', 'address', 'levels', 'religion' ],
     geometry: [ 'point' ],
  ...
  'building/residential/apartments': 
   { name: 'Apartments',
     ...
     terms: [ 'apartment', 'apartment building' ],
     searchable: true },
  'building/residential/detached home': 
   { name: 'Detached Home',
     ...
     terms: [ 'detached', 'detached building' ],
     searchable: true },
  'building/residential/dormitory': 
   { name: 'Dormitory',
     ...
     terms: [ 'dorm', 'dormatorium', 'residence hall' ],
     searchable: true },
  ...
  'building/residential/lodge': 
   { name: 'Lodge',
     ...
     terms: [ 'alpine hut', 'wilderness hut', 'wilderness lodge' ],
     searchable: true },
  ...
  'building/residential/static mobile home': 
   { name: 'Static Mobile Home',
     ...
     terms: [ 'mobile home', 'static caravan' ],
     searchable: true },
  'building/shelter/gazebo': 
   { name: 'Gazebo',
     fields: [ 'name', 'nps/unitcode', 'operator', 'address', 'drinking_water' ],
     geometry: [ 'point' ],
     icon: 'shelter-black',
     maki: 'npmap-symbol-library',
     defaultOrder: null,
     ...
     terms: [ 'alhambra', 'belvedere', 'folly', 'pergola', 'rotunda' ],
     searchable: true },
  ...
  'building/shelter/pavilion': 
   { name: 'Pavilion',
     ...
     defaultOrder: null,
     matchScore: 1,
     tags: { amenity: 'shelter', building: 'pavilion' },
  ...
  'building/shelter/shelter': 
   { name: 'Shelter',
     ...
     defaultOrder: null,
     matchScore: 1,
     tags: { amenity: 'shelter', building: 'hut' },
     terms: 
      [ 'cover',
        'hide',
        'lean-to',
  ...
  'building/storage/garage': 
   { name: 'Garage',
     fields: [ 'name', 'nps/unitcode', 'address', 'levels', 'capacity' ],
     geometry: [ 'point' ],
     icon: 'warehouse',
     maki: 'maki',
     defaultOrder: null,
  ...
  'building/storage/shed': 
   { name: 'Shed',
     ...
     matchScore: 1,
     tags: { building: 'shed' },
     terms: [ 'cache', 'outbuilding', 'shack', 'weatherport' ],
     searchable: true },
  'building/storage/warehouse': 
   { name: 'Warehouse',
     ...
     terms: [ 'storage', 'storage building' ],
     searchable: true },
  ...
  'land recreation/bicycle/bicycle trail': 
   { name: 'Bicycle Trail',
     ...
     defaultOrder: null,
     matchScore: 1.01,
     tags: { highway: 'path', bicycle: '*' },
     terms: [ 'bicycle', 'bike', 'bike trail' ],
     searchable: true },
  ...
  'land recreation/camping/campsite': 
   { name: 'Campsite',
     ...
     defaultOrder: 6,
     matchScore: 1,
     tags: { tourism: 'camp_site', camp_site: 'pitch' },
     terms: [ 'camp site', 'pitch', 'tent pad' ],
     searchable: true },
  'land recreation/camping/dump station': 
   { name: 'Dump Station',
     fields: [ 'name', 'nps/unitcode', 'operator', 'address' ],
     geometry: [ 'point', 'vertex' ],
     ...
     terms: [ 'sanitary disposal station', 'dumpstation' ],
     searchable: true },
  'land recreation/camping/horse camp': 
   { name: 'Horse Camp',
     ...
     defaultOrder: null,
     matchScore: 1.02,
     tags: { tourism: 'camp_site', horse: '*' },
     terms: [ 'horse campground' ],
     searchable: true },
  'land recreation/camping/primitive camping': 
   { name: 'Primitive Camping',
     ...
     defaultOrder: null,
     matchScore: 1,
     tags: { tourism: 'camp_site', camp_site: 'pitch', backcountry: '*' },
     terms: 
      [ 'backcountry',
  ...
  'land recreation/camping/rv campground': 
   { name: 'RV Campground',
     ...
     defaultOrder: 9,
     matchScore: 1,
     tags: { tourism: 'camp_site', caravans: '*' },
     terms: 
      [ 'campground',
        'campervan park',
        'motorcoach park',
  ...
  'land recreation/climbing/canyoneering route': 
   { name: 'Canyoneering Route',
     ...
     defaultOrder: null,
     matchScore: 1,
     tags: { highway: 'path', sport: 'canyoning' },
     searchable: true },
  'land recreation/climbing/climbing route': 
   { name: 'Climbing Route',
     ...
     defaultOrder: null,
     matchScore: 1,
     tags: { highway: 'path', sport: 'climbing' },
     terms: [ 'mountain climbing', 'mountain climbing route' ],
     searchable: true },
  ...
  'land recreation/park/park': 
   { name: 'Park',
     fields: [ 'name', 'nps/unitcode', 'operator', 'address', 'fee' ],
     geometry: [ 'point' ],
     icon: 'park',
     maki: 'maki',
     defaultOrder: null,
  ...
  'land recreation/picnic/grill': 
   { name: 'Grill',
     ...
     matchScore: 1,
     tags: { barbecue_grill: '*' },
     terms: [ 'barbecue', 'barbecue grill', 'bbq', 'bbq grill' ],
     searchable: true },
  ...
  'land recreation/trail/self guiding trail': 
   { name: 'Self Guiding Trail',
     ...
     terms: [ 'guidepost', 'guide post' ],
     searchable: true },
  'land recreation/trail/steps': 
   { name: 'Steps',
     fields: [ 'surface', 'lit', 'width', 'incline_steps', 'access' ],
     geometry: [ 'point' ],
     defaultOrder: null,
     matchScore: 1,
     tags: { highway: 'steps' },
  ...
  'land recreation/trail/trail register': 
   { name: 'Trail Register',
     ...
     defaultOrder: null,
     matchScore: 1,
     tags: { tourism: 'register' },
     terms: [ 'capsule', 'register', 'summit capsule' ],
     searchable: true },
  'land recreation/trail/trailhead': 
   { name: 'Trailhead',
     ...
     terms: [ 'trailend', 'trail end', 'trail head' ],
     searchable: true },
  'miscellaneous/structure/fortification': 
   { name: 'Fortification',
     ...
     defaultOrder: 3,
     matchScore: 1,
     tags: { historic: 'archaeological_site', site_type: 'fortification' },
     terms: [ 'fort', 'earthworks', 'hill fort', 'trench' ],
     searchable: true },
  'miscellaneous/structure/tower': 
   { name: 'Tower',
     fields: [ 'name', 'nps/unitcode', 'operator', 'tower/type' ],
     geometry: [ 'point' ],
     defaultOrder: null,
     matchScore: 1,
     tags: { man_made: 'tower' },
  ...
  'miscellaneous/structure/windmill': 
   { name: 'Windmill',
     fields: [ 'name', 'nps/unitcode', 'operator' ],
     geometry: [ 'point' ],
     defaultOrder: null,
     matchScore: 1,
     tags: { man_made: 'windmill' },
     terms: [ 'wind turbine', 'windpump' ],
     searchable: true },
  ...
  'miscellaneous/cemetery/grave': 
   { name: 'Grave',
     ...
     matchScore: 1,
     tags: { cemetery: 'grave' },
     terms: [ 'burial', 'burial site', 'headstone', 'tomb' ],
     searchable: true },
  ...
  'miscellaneous/mine/historic mine': 
   { name: 'Historic Mine',
     fields: [ 'name', 'nps/unitcode', 'description', 'mineral' ],
     geometry: [ 'point' ],
     defaultOrder: null,
     matchScore: 1,
     tags: { historic: 'mine' },
  ...
  'miscellaneous/mine/quarry (mine)': 
   { name: 'Quarry (Mine)',
     fields: [ 'name', 'nps/unitcode', 'operator', 'resource' ],
     geometry: [ 'point' ],
     defaultOrder: null,
     matchScore: 1,
     tags: { landuse: 'quarry' },
     terms: [ 'quarry', 'mine', 'pit', 'pit mine' ],
     searchable: true },
  'miscellaneous/mine/shaft (mine)': 
   { name: 'Shaft (Mine)',
     ...
     terms: [ 'shaft', 'mine', 'adit', 'mineshaft' ],
     searchable: true },
  ...
  'miscellaneous/oil well/oilfield': 
   { name: 'Oilfield',
     ...
     defaultOrder: null,
     matchScore: 1,
     tags: { man_made: 'oilfield' },
     terms: [ 'oil field', 'oil well', 'pipeline', 'well' ],
     searchable: true },
  ...
  'miscellaneous/reservoir/reservoir': 
   { name: 'Reservoir',
     ...
     defaultOrder: null,
     matchScore: 1,
     tags: { natural: 'water', water: 'reservoir', landuse: 'reservoir' },
     terms: [ 'storage pond', 'water storage', 'water supply' ],
     searchable: true },
  'miscellaneous/view/overlook': 
   { name: 'Overlook',
     ...
     defaultOrder: null,
     matchScore: 1,
     tags: { tourism: 'viewpoint', viewpoint_type: 'overlook' },
     terms: [ 'scenic', 'scenic overlook' ],
     searchable: true },
  ...
  'structure/recreation/boat dock': 
   { name: 'Boat Dock',
     ...
     defaultOrder: 6,
     matchScore: 1,
     tags: { man_made: 'pier', mooring: 'yes' },
     terms: [ 'boat', 'dock', 'pier' ],
     searchable: true },
  'barrier/fence/fence': 
   { name: 'Fence',
     fields: [ 'name', 'nps/unitcode' ],
  ...
  'road/highway/highway link': 
   { name: 'Highway Link',
     ...
     terms: [ 'freeway ramp', 'highway ramp', 'off ramp', 'on ramp', 'ramp' ],
     searchable: true },
  'road/minor/minor road': 
   { name: 'Minor Road',
     ...
     terms: [ 'unclassified', 'unclassified road' ],
     searchable: true },
  ...
  'road/minor/private road': 
   { name: 'Private Road',
     ...
     defaultOrder: 9,
     matchScore: 1,
     tags: { highway: 'road', access: 'private' },
     terms: 
      [ 'private',
        'admin',
        'admin road',
  ...
  'road/minor/residential road': 
   { name: 'Residential Road',
     ...
     terms: [ 'residential', 'local', 'local road' ],
     searchable: true },
  'road/minor/road': 
   { name: 'Road',
     fields: [ 'name', 'nps/unitcode' ],
  ...
  'road/secondary/secondary road': 
   { name: 'Secondary Road',
     ...
     terms: [ 'secondary', 'county highway' ],
     searchable: true },
  'road/service/access road': 
   { name: 'Access Road',
     ...
     terms: [ 'campground road', 'service', 'service road' ],
     searchable: true },
  ...
  'trail/non-motorized/backcountry ski trail': 
   { name: 'Backcountry Ski Trail',
     ...
     terms: [ 'backcountry', 'backcountry ski' ],
     searchable: true },
  ...
  'trail/non-motorized/dog sled trail': 
   { name: 'Dog Sled Trail',
     ...
     terms: [ 'dog sled', 'mushing', 'mushing trail', 'winter track' ],
     searchable: true },
  ...
  'trail/non-motorized/pedestrian path': 
   { name: 'Pedestrian Path',
     ...
     terms: [ 'footway', 'pedestrian trail' ],
     searchable: true },
  ...
  'trail/unmaintained/unmaintained route': 
   { name: 'Unmaintained Route',
     ...
     defaultOrder: null,
     matchScore: 1,
     tags: { highway: 'path', mainenance: 'no' },
     terms: [ 'unmaintained' ],
     searchable: true },
  ...
  'trail/water/motorized watercraft trail': 
   { name: 'Motorized Watercraft Trail',
     ...
     defaultOrder: null,
     matchScore: 1,
     tags: { motorboat: '*', waterway: '*' },
     terms: [ 'motorized watercraft', 'motorboat' ],
     searchable: true },
  'trail/water/non-motorized watercraft trail': 
   { name: 'Non-Motorized Watercraft Trail',
     ...
     defaultOrder: null,
     matchScore: 1,
     tags: { canoe: '*', waterway: '*', motorboat: 'no' },
     terms: [ 'non-motorized watercraft', 'canoe', 'kayak', 'raft' ],
     searchable: true },
  ...
  'accommodation/floating restroom/floating restroom': 
   { name: 'Floating Restroom',
     ...
     defaultOrder: null,
     matchScore: 1,
     tags: { amenity: 'toilets', type: 'floating' },
     searchable: true },
  ...
  'historic/battlefield/battlefield': 
   { name: 'Battlefield',
     ...
     defaultOrder: null,
     matchScore: 1,
     tags: { historic: 'battlefield' },
     terms: [ 'historic battlefield', 'battle' ],
     searchable: true },
  'historic/cannon/cannon': 
   { name: 'Cannon',
     ...
     terms: [ 'historic cannon', 'artillery', 'battering ram', 'catapult' ],
     searchable: true },
  'historic/marker/battlefield marker': 
   { name: 'Battlefield Marker',
     ...
     defaultOrder: null,
     matchScore: 1,
     tags: { historic: 'marker', marker_type: 'battlefield' },
     searchable: true },
  ...
  'historic/wreck/wreck': 
   { name: 'Wreck',
     ...
     matchScore: 1,
     tags: { historic: 'wreck' },
     terms: [ 'shipwreck', 'submerged wreck' ],
     searchable: true },
  'information/information/brochure box': 
   { name: 'Brochure Box',
     ...
     defaultOrder: null,
     matchScore: 1,
     tags: { tourism: 'information', information: 'brochure' },
     terms: 
      [ 'brochure holder',
        'brochure dispenser',
        'dispenser',
  ...
  'information/information/information': 
   { name: 'Information',
     ...
     terms: [ 'tourist information', 'visitor information' ],
     searchable: true },
  'information/information/information board': 
   { name: 'Information Board',
     ...
     terms: [ 'bulletin board', 'information kiosk', 'kiosk' ],
     searchable: true },
  ...
  'information/information/interpretive exhibit': 
   { name: 'Interpretive Exhibit',
     ...
     defaultOrder: null,
     matchScore: 1,
     tags: { tourism: 'information', information: 'exhibit' },
     terms: 
      [ 'attraction',
        'exhibit',
        'exhibit / wayside',
  ...
  'information/sign/gateway sign': 
   { name: 'Gateway Sign',
     ...
     defaultOrder: null,
     matchScore: 1,
     tags: { tourism: 'information', information: 'sign' },
     terms: [ 'sign', 'gateway', 'location', 'place name' ],
     searchable: true },
  ...
  'information/visitor center/visitor center': 
   { name: 'Visitor Center',
     ...
     defaultOrder: -8,
     matchScore: 1,
     tags: { tourism: 'information', information: 'office' },
     terms: [ 'information', 'visitor centre', 'visitor information' ],
     searchable: true },
  'locality/region/cultural landscape': 
   { name: 'Cultural Landscape',
     ...
     defaultOrder: null,
     matchScore: 1,
     tags: { place: 'locality', historic: 'landscape' },
     searchable: true },
  'locality/region/historic district': 
   { name: 'Historic District',
     ...
     defaultOrder: null,
     matchScore: 1,
     tags: { place: 'locality', historic: 'district' },
     searchable: true },
  'locality/region/junction': 
   { name: 'Junction',
     ...
     defaultOrder: null,
     matchScore: 1,
     tags: { place: 'locality', locality_type: 'junction' },
     searchable: true },
  ...
  'locality/region/populated place': 
   { name: 'Populated Place',
     fields: [ 'name', 'nps/unitcode', 'population' ],
     geometry: [ 'point' ],
     defaultOrder: null,
     matchScore: 1,
     tags: { place: 'hamlet' },
     terms: [ 'city', 'hamlet', 'neighborhood', 'place', 'town' ],
     searchable: true },
  'natural feature/arroyo/arroyo': 
   { name: 'Arroyo',
     ...
     defaultOrder: null,
     matchScore: 1,
     tags: { waterway: 'drain', intermittent: '*' },
     terms: [ 'coulee', 'draw', 'gully', 'wash' ],
     searchable: true },
  ...
  'natural feature/bar/shoal (bar)': 
   { name: 'Shoal (Bar)',
     fields: [ 'name', 'nps/unitcode', 'tidal' ],
     geometry: [ 'point' ],
     defaultOrder: null,
     matchScore: 1,
     tags: { natural: 'shoal' },
  ...
  'natural feature/basin/basin': 
   { name: 'Basin',
     ...
     matchScore: 1,
     tags: { landuse: 'basin' },
     terms: [ 'cirque', 'hole', 'sink', 'sinkhole' ],
     searchable: true },
  'natural feature/bay/bay': 
   { name: 'Bay',
     ...
     matchScore: 1,
     tags: { natural: 'bay' },
     terms: [ 'arm', 'bight', 'cove', 'estuary', 'gulf', 'inlet', 'sound' ],
     searchable: true },
  'natural feature/beach/beach': 
   { name: 'Beach',
     fields: [ 'name', 'nps/unitcode', 'surface' ],
     geometry: [ 'point' ],
     defaultOrder: null,
     matchScore: 1,
     tags: { natural: 'beach' },
     terms: [ 'coast', 'shore', 'strand' ],
     searchable: true },
  'natural feature/cape/cape': 
   { name: 'Cape',
     ...
     matchScore: 1,
     tags: { natural: 'cape' },
     terms: [ 'lea', 'neck', 'peninsula', 'point' ],
     searchable: true },
  'natural feature/cave/cave entrance': 
   { name: 'Cave Entrance',
     ...
     terms: [ 'cave', 'cavern', 'grotto' ],
     searchable: true },
  'natural feature/cliff/cliff': 
   { name: 'Cliff',
     fields: [ 'name', 'nps/unitcode', 'height' ],
     geometry: [ 'point' ],
     defaultOrder: null,
     matchScore: 1,
     tags: { natural: 'cliff' },
  ...
  'natural feature/forest/forest': 
   { name: 'Forest',
     fields: [ 'name', 'nps/unitcode', 'leaf_type', 'leaf_cycle', 'crop' ],
     geometry: [ 'point' ],
     icon: 'park',
     maki: 'maki',
     defaultOrder: null,
  ...
  'natural feature/glacier/glacier': 
   { name: 'Glacier',
     fields: [ 'name', 'nps/unitcode', 'surface', 'direction' ],
     geometry: [ 'point' ],
     defaultOrder: null,
     matchScore: 1,
     tags: { natural: 'glacier' },
     terms: [ 'icefield', 'ice patch', 'snow patch' ],
     searchable: true },
  ...
  'natural feature/lava/lava': 
   { name: 'Lava',
     ...
     matchScore: 1,
     tags: { natural: 'lava' },
     terms: [ 'jumble', 'kepula', 'lava bed', 'lava flow', 'pyroclastic flow' ],
     searchable: true },
  ...
  'natural feature/plain/plain': 
   { name: 'Plain',
     ...
     defaultOrder: null,
     matchScore: 1,
     tags: { natural: 'grassland', grassland_type: 'plain' },
     terms: [ 'highland', 'kula', 'meadow', 'upland' ],
     searchable: true },
  'natural feature/plain/prairie': 
   { name: 'Prairie',
     ...
     defaultOrder: null,
     matchScore: 1,
     tags: { natural: 'grassland', grassland: 'prarie' },
     terms: [ 'savanna', 'steppe' ],
     searchable: true },
  'natural feature/plateau/plateau': 
   { name: 'Plateau',
     ...
     defaultOrder: null,
     matchScore: 1,
     tags: { natural: 'landform', landform: 'plateau' },
     terms: [ 'mesa', 'table', 'tableland' ],
     searchable: true },
  'natural feature/rapids/rapids': 
   { name: 'Rapids',
     fields: [ 'name', 'nps/unitcode', 'whitewater', 'width', 'rapid_grade' ],
     geometry: [ 'point', 'vertex' ],
     icon: 'water',
     maki: 'maki',
     defaultOrder: null,
  ...
  'natural feature/ridge/ridge': 
   { name: 'Ridge',
     ...
     matchScore: 1,
     tags: { natural: 'ridge' },
     terms: [ 'crest', 'cuesta', 'escarpment', 'hogback', 'lae', 'spur' ],
     searchable: true },
  'natural feature/rock formation/arch': 
   { name: 'Arch',
     ...
     matchScore: 1,
     tags: { natural: 'arch' },
     terms: [ 'bridge', 'land bridge', 'natural bridge', 'sea arch', 'window' ],
     searchable: true },
  'natural feature/rock formation/pillar': 
   { name: 'Pillar',
     ...
     defaultOrder: null,
     matchScore: 1,
     tags: { natural: 'rock', rock_type: 'pillar' },
     terms: [ 'chimney', 'monument', 'pinnacle', 'pohaku', 'rock tower' ],
     searchable: true },
  ...
  'natural feature/spring/spring': 
   { name: 'Spring',
     fields: [ 'name', 'nps/unitcode', 'drinking_water' ],
     geometry: [ 'point' ],
     icon: 'spring-black',
     maki: 'npmap-symbol-library',
     defaultOrder: null,
  ...
  'natural feature/swamp/swamp': 
   { name: 'Swamp',
     ...
     defaultOrder: null,
     matchScore: 1,
     tags: { natural: 'wetland', wetland: 'swamp' },
     terms: [ 'bog', 'cienega', 'marais', 'marsh', 'mire', 'pocosin' ],
     searchable: true },
  'natural feature/thermal/fumarole': 
   { name: 'Fumarole',
     ...
     defaultOrder: null,
     matchScore: 1,
     tags: { natural: 'fumarole' },
     terms: [ 'steam', 'vent', 'volcanic gas' ],
     searchable: true },
  'natural feature/thermal/geyser': 
   { name: 'Geyser',
     ...
     matchScore: 1,
     tags: { natural: 'geyser' },
     terms: [ 'gusher', 'spout', 'thermal geyser' ],
     searchable: true },
  'natural feature/thermal/hot spring': 
   { name: 'Hot Spring',
     ...
     terms: [ 'hot', 'spring', 'thermal spring' ],
     searchable: true },
  'natural feature/thermal/mud pot': 
   { name: 'Mud Pot',
     ...
     matchScore: 1,
     tags: { natural: 'mud' },
     terms: [ 'mud', 'mud flow', 'mudflow', 'thermal pool' ],
     searchable: true },
  ...
  'natural feature/valley/valley': 
   { name: 'Valley',
     ...
     matchScore: 1,
     tags: { natural: 'valley' },
     terms: [ 'barranca', 'chasm', 'glen', 'gorge', 'gulch', 'hollow', 'ravine' ],
     searchable: true },
  'natural feature/volcano/volcano': 
   { name: 'Volcano',
     fields: [ 'name', 'nps/unitcode', 'status', 'ele', 'type' ],
     geometry: [ 'point' ],
     icon: 'triangle',
     maki: 'maki',
     defaultOrder: null,
  ...
  'road feature/bridge/bridge': 
   { name: 'Bridge',
     ...
     matchScore: 1,
     tags: { bridge: '*' },
     terms: [ 'aqueduct', 'overpass', 'viaduct' ],
     searchable: true },
  'road feature/control/traffic signals': 
   { name: 'Traffic Signals',
     ...
     terms: [ 'stoplight', 'stop light', 'traffic light', 'traffic signal' ],
     searchable: true },
  'road feature/no-outlet/turning circle': 
   { name: 'Turning Circle',
     ...
     terms: [ 'blind alley', 'cul-de-sac', 'dead end street' ],
     searchable: true },
  'road feature/tunnel/tunnel': 
   { name: 'Tunnel',
     ...
     matchScore: 1,
     tags: { tunnel: '*' },
     terms: [ 'covered passageway', 'covered way' ],
     searchable: true },
  'service/airport/airport': 
   { name: 'Airport',
     fields: [ 'name', 'nps/unitcode', 'operator', 'address', 'icao', 'iata' ],
     geometry: [ 'point' ],
     icon: 'airport-black',
     maki: 'npmap-symbol-library',
     defaultOrder: null,
  ...
  'service/airport/airstrip': 
   { name: 'Airstrip',
     ...
     defaultOrder: null,
     matchScore: 1,
     tags: { aeroway: 'aerodrome', aerodrome: 'airstrip' },
     terms: [ 'airfield', 'air field', 'landing field' ],
     searchable: true },
   ...
   { name: 'Landing Strip',
     ...
     tags: 
      { aeroway: 'aerodrome',
        aerodrome: 'airstrip',
        surface: 'ground' },
     terms: [ 'landing spot', 'plane landing' ],
     searchable: true },
  'service/airport/seaplane base': 
   { name: 'Seaplane Base',
     ...
     terms: [ 'float landing', 'float plane' ],
     searchable: true },
  'service/bank/atm': 
   { name: 'ATM',
     fields: [ 'name', 'nps/unitcode', 'operator', 'fee' ],
     geometry: [ 'point' ],
     defaultOrder: null,
     matchScore: 1,
     tags: { amenity: 'atm' },
     terms: [ 'automated teller machine', 'cash', 'cash dispenser' ],
     searchable: true },
  'service/bus/bus stop %2f shuttle stop': 
   { name: 'Bus Stop / Shuttle Stop',
     ...
     terms: [ 'bus stop', 'shuttle stop', 'bus station' ],
     searchable: true },
  'service/entertainment/amphitheater': 
   { name: 'Amphitheater',
     ...
     defaultOrder: null,
     matchScore: 1,
     tags: { amenity: 'theatre', 'theatre:type': 'amphi' },
     terms: 
      [ 'theatre',
        'theater',
        'opera house',
  ...
  'service/entertainment/cinema': 
   { name: 'Cinema',
     ...
     matchScore: 1,
     tags: { amenity: 'cinema' },
     terms: [ 'movie', 'movies', 'movie theater', 'film', 'picture' ],
     searchable: true },
  'service/entrance/entrance station': 
   { name: 'Entrance Station',
     ...
     terms: [ 'entrance', 'entry', 'exit', 'portal' ],
     searchable: true },
  'service/entrance/fee booth': 
   { name: 'Fee Booth',
     ...
     terms: [ 'fee', 'toll', 'toll booth' ],
     searchable: true },
  'service/ferry/ferry terminal': 
   { name: 'Ferry Terminal',
     fields: [ 'name', 'nps/unitcode', 'operator', 'address', 'cargo' ],
     geometry: [ 'point' ],
     icon: 'ferry',
     maki: 'maki',
     defaultOrder: null,
     ...
     terms: [ 'ferry', 'terminal', 'boat terminal' ],
     searchable: true },
  ...
  'service/parking/electric vehicle parking': 
   { name: 'Electric Vehicle Parking',
     ...
     defaultOrder: null,
     matchScore: 1,
     tags: { amenity: 'parking', 'capacity:charging': '*' },
     terms: 
      [ 'electric',
        'electric car',
        'electric vehicle',
  ...
  'service/post/mailbox': 
   { name: 'Mailbox',
     ...
     terms: [ 'mail box', 'mail drop', 'postbox', 'post box' ],
     searchable: true },
  'service/post/post office': 
   { name: 'Post Office',
     ...
     terms: [ 'letter', 'mail', 'mail office', 'package', 'parcel', 'post' ],
     searchable: true },
  'service/rail/metro stop %2f subway entrance': 
   { name: 'Metro Stop / Subway Entrance',
     ...
     terms: [ 'metro stop', 'subway entrance', 'subway exit' ],
     searchable: true },
  'service/rail/train station': 
   { name: 'Train Station',
     ...
     terms: [ 'depot', 'railroad station', 'railway station', 'station' ],
     searchable: true },
  'service/shopping/bookstore': 
   { name: 'Bookstore',
     ...
     matchScore: 1,
     tags: { shop: 'books' },
     terms: [ 'book', 'reading', 'shop', 'shopping', 'store' ],
     searchable: true },
  'service/shopping/gift shop': 
   { name: 'Gift Shop',
     ...
     matchScore: 1,
     tags: { shop: 'gift' },
     terms: [ 'gift', 'shop', 'shopping', 'store' ],
     searchable: true },
  'service/shopping/store': 
   { name: 'Store',
     ...
     matchScore: 1,
     tags: { shop: 'general' },
     terms: [ 'shop', 'shopping', 'general store' ],
     searchable: true },
  'service/showers/showers': 
   { name: 'Showers',
     ...
     matchScore: 1,
     tags: { amenity: 'shower' },
     terms: [ 'bath', 'bathhouse', 'bath house', 'shower' ],
     searchable: true },
  'service/support/emergency telephone': 
   { name: 'Emergency Telephone',
     ...
     terms: [ 'emergency phone', 'phone', 'emergency' ],
     searchable: true },
  ...
  'service/support/fire station': 
   { name: 'Fire Station',
     ...
     terms: [ 'fire department', 'emergency' ],
     searchable: true },
  'service/support/first aid station': 
   { name: 'First Aid Station',
     ...
     defaultOrder: null,
     matchScore: 1,
     tags: { amenity: 'first_aid' },
     terms: [ 'clinic', 'first aid', 'medical', 'medical clinic', 'emergency' ],
     searchable: true },
  ...
  'service/telephone/telephone': 
   { name: 'Telephone',
     fields: [ 'name', 'nps/unitcode', 'operator', 'address', 'indoor' ],
     geometry: [ 'point' ],
     icon: 'telephone-black',
     maki: 'npmap-symbol-library',
     defaultOrder: 17,
     ...
     terms: [ 'pay phone', 'phone', 'telephone box', 'phone booth' ],
     searchable: true },
  ...
  'service/waste/litter receptacle': 
   { name: 'Litter Receptacle',
     fields: [ 'name', 'nps/unitcode', 'operator', 'address', 'waste', 'bin' ],
     geometry: [ 'point' ],
  ...
  'service/water/potable water': 
   { name: 'Potable Water',
     ...
     terms: [ 'drinking fountain', 'drinking water', 'potable' ],
     searchable: true },
  ...
  'service/water/water well': 
   { name: 'Water Well',
     fields: [ 'name', 'nps/unitcode', 'operator', 'drinking_water', 'pump' ],
     geometry: [ 'point' ],
     defaultOrder: null,
     matchScore: 1,
  ...
  'water recreation/access/canoe %2f kayak access': 
   { name: 'Canoe / Kayak Access',
     ...
     defaultOrder: null,
     matchScore: 1,
     tags: { leisure: 'slipway', canoe: '*', motorboat: 'no' },
     terms: [ 'canoe', 'canoe access', 'kayak', 'raft' ],
     searchable: true },
  ...
  'water recreation/boat/sailing': 
   { name: 'Sailing',
     ...
     matchScore: 1,
     tags: { sport: 'sailing' },
     terms: [ 'sail', 'sailing area', 'sail area' ],
     searchable: true },
  'water recreation/boat/zebra mussel decontamination station': 
   { name: 'Zebra Mussel Decontamination Station',
     ...
     defaultOrder: null,
     matchScore: 1,
     tags: { amenity: 'boat_wash', type: 'zebra_mussel' },
     terms: [ 'decontamination', 'decontamination station' ],
     searchable: true },
  'water recreation/fishing/fish cleaning': 
   { name: 'Fish Cleaning',
     ...
     terms: [ 'cleaning', 'fish cleaning station', 'fish cleaning table' ],
     searchable: true },
  ...
  'water recreation/windsurfing/windsurfing area': 
   { name: 'Windsurfing Area',
     ...
     defaultOrder: null,
     matchScore: 1,
     tags: { sport: 'windsurfing' },
     terms: [ 'windsurfing', 'wind surfing', 'wind surfing area' ],
     searchable: true },
...
******************************************************************************************
******************************************************************************************
preset { name: 'Building Footprint',
  fields: [ 'name', 'nps/unitcode', 'address', 'levels' ],
  geometry: [ 'area' ],
  icon: 'building',
  maki: 'maki',
...
******************************************************************************************
******************************************************************************************
preset { name: 'Building Under Construction',
  fields: [ 'name', 'nps/unitcode', 'address', 'levels' ],
  geometry: [ 'point' ],
  icon: 'building',
  maki: 'maki',
...
******************************************************************************************
******************************************************************************************
preset { name: 'Administrative Office',
  fields: [ 'name', 'nps/unitcode', 'operator', 'address', 'opening_hours' ],
  geometry: [ 'point' ],
  icon: 'commercial',
  maki: 'maki',
...
******************************************************************************************
******************************************************************************************
preset { name: 'Commercial Building',
  fields: [ 'name', 'nps/unitcode', 'address', 'levels', 'smoking' ],
  geometry: [ 'point' ],
  icon: 'commercial',
  maki: 'maki',
...
******************************************************************************************
******************************************************************************************
preset { name: 'Industrial Building',
  fields: [ 'name', 'nps/unitcode', 'address', 'levels', 'smoking' ],
  geometry: [ 'point' ],
  icon: 'industrial',
  maki: 'maki',
...
******************************************************************************************
******************************************************************************************
preset { name: 'University Building',
  fields: [ 'name', 'nps/unitcode', 'address', 'levels' ],
  geometry: [ 'point' ],
  icon: 'college',
  maki: 'maki',
...
******************************************************************************************
******************************************************************************************
preset { name: 'Residential Building',
  fields: [ 'name', 'nps/unitcode', 'address', 'levels' ],
  geometry: [ 'point' ],
  icon: 'building',
  maki: 'maki',
...
******************************************************************************************
******************************************************************************************
preset { name: 'Static Mobile Home',
  fields: [ 'name', 'nps/unitcode', 'address', 'levels' ],
  geometry: [ 'point' ],
  icon: 'building',
  maki: 'maki',
...
******************************************************************************************
******************************************************************************************
preset { name: 'All-Terrain Vehicle Trail',
  fields: 
   [ 'name',
     'nps/unitcode',
     'operator',
...
******************************************************************************************
******************************************************************************************
preset { name: 'Four-Wheel Drive Trail',
  fields: 
   [ 'name',
     'nps/unitcode',
     'operator',
...
******************************************************************************************
******************************************************************************************
preset { name: 'Canyoneering Route',
  fields: [ 'name', 'nps/unitcode' ],
  geometry: [ 'point' ],
  defaultOrder: null,
  matchScore: 1,
...
******************************************************************************************
******************************************************************************************
preset { name: 'Food Box / Food Cache',
  fields: [ 'name', 'nps/unitcode' ],
  geometry: [ 'point' ],
  icon: 'food-cache-black',
  maki: 'npmap-symbol-library',
...
******************************************************************************************
******************************************************************************************
preset { name: 'Non-Motorized Trail',
  fields: 
   [ 'name',
     'nps/unitcode',
     'operator',
...
******************************************************************************************
******************************************************************************************
preset { name: 'Self Guiding Trail',
  fields: [ 'name', 'nps/unitcode', 'operator', 'address', 'opening_hours' ],
  geometry: [ 'point' ],
  icon: 'self-guiding-trail-black',
  maki: 'npmap-symbol-library',
...
******************************************************************************************
******************************************************************************************
preset { name: 'Cemetery / Graveyard',
  fields: [ 'name', 'nps/unitcode' ],
  geometry: [ 'point' ],
  icon: 'cemetery',
  maki: 'maki',
...
******************************************************************************************
******************************************************************************************
preset { name: 'Four-Wheel Drive Road',
  fields: 
   [ 'name',
     'nps/unitcode',
     'operator',
...
******************************************************************************************
******************************************************************************************
preset { name: 'Backcountry Ski Trail',
  fields: 
   [ 'name',
     'nps/unitcode',
     'operator',
...
******************************************************************************************
******************************************************************************************
preset { name: 'Cross-Country Ski Trail',
  fields: 
   [ 'name',
     'nps/unitcode',
     'operator',
...
******************************************************************************************
******************************************************************************************
preset { name: 'Downhill Ski Trail',
  fields: 
   [ 'name',
     'nps/unitcode',
     'operator',
...
******************************************************************************************
******************************************************************************************
preset { name: 'Horseback Riding Trail',
  fields: 
   [ 'name',
     'nps/unitcode',
     'operator',
...
******************************************************************************************
******************************************************************************************
preset { name: 'Unmaintained Route',
  fields: 
   [ 'name',
     'nps/unitcode',
     'operator',
...
******************************************************************************************
******************************************************************************************
preset { name: 'Motorized Watercraft Trail',
  fields: 
   [ 'name',
     'nps/unitcode',
     'operator',
...
******************************************************************************************
******************************************************************************************
preset { name: 'Non-Motorized Watercraft Trail',
  fields: 
   [ 'name',
     'nps/unitcode',
     'operator',
...
******************************************************************************************
******************************************************************************************
preset { name: 'Wheelchair Accessible',
  fields: [ 'name', 'nps/unitcode' ],
  geometry: [ 'point' ],
  icon: 'wheelchair-accessible-black',
  maki: 'npmap-symbol-library',
...
******************************************************************************************
******************************************************************************************
preset { name: 'Battlefield Marker',
  fields: [ 'name', 'nps/unitcode' ],
  geometry: [ 'point' ],
  defaultOrder: null,
  matchScore: 1,
...
******************************************************************************************
******************************************************************************************
preset { name: 'Interpretive Exhibit',
  fields: [ 'name', 'nps/unitcode', 'operator', 'address', 'opening_hours' ],
  geometry: [ 'point', 'vertex' ],
  icon: 'information-black',
  maki: 'npmap-symbol-library',
...
******************************************************************************************
******************************************************************************************
preset { name: 'Cultural Landscape',
  fields: [ 'name', 'nps/unitcode' ],
  geometry: [ 'point' ],
  defaultOrder: null,
  matchScore: 1,
...
******************************************************************************************
******************************************************************************************
preset { name: 'Mountain Pass (Saddle / Gap)',
  fields: [ 'name', 'nps/unitcode', 'ele', 'direction' ],
  geometry: [ 'point' ],
  defaultOrder: null,
  matchScore: 1,
...
******************************************************************************************
******************************************************************************************
preset { name: 'Bus Stop / Shuttle Stop',
  fields: 
   [ 'name',
     'nps/unitcode',
     'operator',
...
******************************************************************************************
******************************************************************************************
preset { name: 'Electric Vehicle Parking',
  fields: [ 'name', 'nps/unitcode' ],
  geometry: [ 'point' ],
  defaultOrder: null,
  matchScore: 1,
...
******************************************************************************************
******************************************************************************************
preset { name: 'Metro Stop / Subway Entrance',
  fields: [ 'name', 'nps/unitcode' ],
  geometry: [ 'point' ],
  icon: 'rail-metro',
  maki: 'maki',
...
******************************************************************************************
******************************************************************************************
preset { name: 'Emergency Telephone',
  fields: [ 'name', 'nps/unitcode', 'operator', 'address' ],
  geometry: [ 'point' ],
  icon: 'telephone-black',
  maki: 'npmap-symbol-library',
...
******************************************************************************************
******************************************************************************************
preset { name: 'Canoe / Kayak Access',
  fields: 
   [ 'name',
     'nps/unitcode',
     'operator',
...
******************************************************************************************
******************************************************************************************
preset { name: 'Zebra Mussel Decontamination Station',
  fields: [ 'name', 'nps/unitcode' ],
  geometry: [ 'point' ],
  defaultOrder: null,
  matchScore: 1,
